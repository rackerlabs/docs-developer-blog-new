# Generates Simple Release Notes given a release version and Sprint Project.
# The output can then be clipped into /content/news/release-notes.adoc as the
# base for that version's release notes.
#
# Requires:
# - a github oauth token with public_repo and read:org scopes
